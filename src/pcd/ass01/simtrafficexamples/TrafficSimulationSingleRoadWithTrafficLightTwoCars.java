...
public class TrafficSimulationSingleRoadWithTrafficLightTwoCars extends AbstractSimulation {
	...
	public String toString() {
		return "Single Road With Traffic Light Two Cars";
	}
	...
	public void setup() {
		...
		CarAgent car1 = new CarAgentExtended("car-1", env, r, 0, 0.1, 0.3, 6, getDt());
		this.addAgent(car1);		
		CarAgent car2 = new CarAgentExtended("car-2", env, r, 100, 0.1, 0.3, 5, getDt());
		this.addAgent(car2);
