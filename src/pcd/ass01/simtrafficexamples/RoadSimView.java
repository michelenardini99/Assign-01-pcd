...
import pcd.ass01.simenginecunc.AbstractAgent;
import pcd.ass01.simenginecunc.AbstractEnvironment;
import pcd.ass01.simenginecunc.SimulationListener;
...
public class RoadSimView extends JFrame implements SimulationListener {
	...
	public void notifyStepDone(int t, List<AbstractAgent> agents, AbstractEnvironment env) {
		...
		if(env.isLastStep() || env.isStopped()){
			this.dispose();
		}
	}
